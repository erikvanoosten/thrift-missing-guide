...
the Thrift tutorial. For understanding of Thrift's internals you are referred to the
https://thrift.apache.org/static/files/thrift-20070401.pdf[Thrift white paper (pdf)]
and the https://erikvanoosten.github.io/thrift-missing-specification/[Thrift missing specification].
